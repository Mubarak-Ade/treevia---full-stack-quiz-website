    ...
    const featureCards = [
        {
            ...
            description:
                "Questions that evolve with you. Our adaptive engine ensures you're always challenged at the right level.",
            className:
                'rounded-4xl lg:col-start-1 lg:col-end-3 md:col-start-1 md:col-end-3 relative bg-surface overflow-hidden dark:bg-dark-neutral p-10 text-foreground shadow-[0_24px_60px_-40px_var(--shadow-sage-500)] backdrop-blur-sm',
        },
        {
            title: 'Fresh Content',
            description:
                "Questions that evolve with you. Our adaptive engine ensures you're always challenged at the right level.",
            className:
                'rounded-4xl relative bg-surface overflow-hidden dark:bg-dark-neutral p-10 text-foreground shadow-[0_24px_60px_-40px_var(--shadow-sage-500)] backdrop-blur-sm',
        },
        {
            title: 'Flourish Together',
            description:
        ...
        },
        {
            ...
            description:
                "Questions that evolve with you. Our adaptive engine ensures you're always challenged at the right level.",
            className:
                'rounded-4xl lg:col-start-2 lg:col-end-4 md:col-start-1 md:col-end-3 relative bg-surface overflow-hidden dark:bg-dark-neutral p-10 text-foreground shadow-[0_24px_60px_-40px_var(--shadow-sage-500)] backdrop-blur-sm',
        },
    ];

    return (
        <section className="p-10">
            <Reveal className="my-8 space-y-4 flex flex-col items-center text-center">
                <h1 className="text-secondary flex flex-col justify-center items-center dark:text-white text-2xl md:text-5xl font-extrabold">
                    Why Choose Treevia?
                    <span className="w-[80%] h-1 mt-2 bg-primary dark:bg-primary" />
                </h1>
            ...
            <Stagger className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:px-10 gap-10 text-left">
                {featureCards.map(card => (
                    <Reveal key={card.title} className={card.className}>
                        ...
                        <h3 className="text-2xl text-primary mb-4 font-semibold">{card.title}</h3>
            ...
            <Reveal className="relative mt-16 shadow-[0_0_25px] shadow-[rgba(0,0,0,0.15)] overflow-hidden rounded-[2.5rem] bg-cta  px-6 py-16 text-center text-white md:px-10">
                ...
                <div className="mx-auto max-w-2xl">
                    ...
                    <Button asChild className="mt-10 bg-brand px-8 py-4 text-sm font-semibold text-on-brand shadow-[0_24px_60px_-30px_rgba(0,0,0,0.35)]">
                        <Link to="/login">
                            Plant Your Account
                        </Link>
                    </Button>
