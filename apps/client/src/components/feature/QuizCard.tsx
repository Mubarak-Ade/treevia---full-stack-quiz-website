  ...
  id, title, category, timelimit, difficulty, attempts, rating 
    ...
    return (
        <div className="bg-white text-custom-700 overflow-hidden p-6.25 text-start rounded-xl">
            ...
            <p className="text-sm text-primary mb-2.5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, aspernatur?</p>
            <div className="flex justify-between text-sm text-tertiary mb-2.5">
