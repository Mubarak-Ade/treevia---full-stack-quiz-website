...
import {
    useCreateCategory,
    useEditCategory,
} from '@/modules/admin/category/controllers/admin-category.controller';
...
const schema = z.object({
    ...
    tags: z
        ...
        .refine(tags => tags.every(tag => tag.length >= 2), {
    ...
    return (
        <FormProvider {...methods}>
            <form id="category-form" onSubmit={handleSubmit(onSubmit)} className="p-5 space-y-2">
                <InputField<FormData> label="Category Name" name="name" placeholder="e.g Science" />
                <InputField<FormData>
                    label="Description"
                    name="description"
                    placeholder="Briefly describe this category"
                />
                <Field className="text-secondary overflow-hidden">
                    ...
                    <div className="flex gap-2 overflow-auto bg-background items-center p-2 rounded-lg border border-muted focus:ring-muted focus:ring outline-none">
                        ...
                        <Input
                            ...
                            className="p-5 w-full overflow-auto outline-none focus-visible:ring-0 border-0"
                        />
                    </div>
