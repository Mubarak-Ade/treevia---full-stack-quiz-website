		...
		<div className="flex items-center justify-between p-3 border-b border-default">
			<Link to="/" className="flex gap-4 items-center">
				<img
					...
					alt="Logo"
				/>
				<h1 className={`md:text-4xl text-3xl font-pacifico text-primary`}>Treevia</h1>
			</Link>
			<div className="flex gap-4 items-center">
				<div className="text-white bg-red-800 px-4 py-1 font-bold rounded-full">
					<p>{minutes}:{seconds.toString().padStart(2, "0")}</p>
				</div>
				<button onClick={onClick} className="flex font-ubuntu items-center text-xs gap-2 bg-band text-primary font-bold rounded-full px-3 py-2 cursor-pointer">
					{icon}{label}
				</button>
			</div>
		</div>
