...
export const ProfileMenu = ({ display, user, logout, setDisplay }: MenuProps) => {
    ...
    return (
        <AnimatePresence>
            {display && (
                ...
                >
                    <h4 className="capitalize text-sm text-custom">{user?.username}</h4>
                    <h6 className="text-xs font-light text-secondary mt-1">{user?.email}</h6>
