...
{
	return (
		<div className='bg-linear-135 text-white items-center flex-col text-center overflow-hidden flex justify-center py-15 px-10 flex-1 from-[#40916c] via-[#52b788] to-[#74c69d] rounded-l-3xl'>
