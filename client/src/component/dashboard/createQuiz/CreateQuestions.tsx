...
function CreateQuestions ()
{
    ...
    const handleSubmit = async ( e ) =>
    {
        ...
        if (question !== "" && options.every(opt => opt !== "") && correctAnswer !== "") {
            try {
                await api.post(`/quiz/${id}/questions`, questionData);
        ...
        <div className="p-4 flex flex-col items-center">
            ...
            <form onSubmit={ handleSubmit } className="w-2xl">
                ...
                <div className="flex justify-between mt-4">
                    ...
                    <button type="submit" className="py-2 px-6 bg-treevia-custom font-medium border rounded-xl text-treevia-primary">Save All Questions</button>
                </div>
            </form>
        </div>
    );
